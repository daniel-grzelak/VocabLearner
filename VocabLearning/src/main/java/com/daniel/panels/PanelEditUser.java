...
public class PanelEditUser extends JPanel implements ActionListener {
	...
	public PanelEditUser(String username) {
		super(new BorderLayout());
		this.username = username;
		List<WordsAll> words = Database.selectWordsUser(username);
		List<String> headers = new ArrayList<>(Arrays.asList(new String[] { "ID", "POLISH", "ENGLISH", "INTERVAL" }));
